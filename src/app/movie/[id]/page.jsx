...
export default function MoviePage() {
  ...
  const cast = credits?.cast.slice(0, 20); // Get a few more cast members
          ...
          <div className="md:flex md:gap-8">
            ...
            <div className="md:w-2/3 mt-8 md:mt-0">
              ...
              <div className="flex items-center gap-4 mt-6">
                <button className="bg-stone-700 hover:bg-stone-600 text-white font-bold p-3 rounded-full transition-colors" title="Add to Watchlist">
                  <FaBookmark />
                </button>
                <button className="bg-stone-700 hover:bg-stone-600 text-white font-bold p-3 rounded-full transition-colors" title="Add to Favorites">
                  <FaHeart />
                </button>
                <button className="bg-stone-700 hover:bg-stone-600 text-white font-bold p-3 rounded-full transition-colors" title="Add to List">
                  <FaList />
                </button>
                {trailer && (
                  <button 
